...
<div class="container container-info">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            <li><a href="" style="color: grey; background-color: #eeeeee;">修改物品信息</a></li>
        </ul>
    </div>
    <div class="col-md-8">
        <form action="#" class="form-horizontal">
            <h3 class="text-danger text-center">修改物品信息</h3>
            <div class="form-group">
                <label for="item_name" class="col-sm-2  control-label">名称</label>
                <div class="col-sm-8">
                    <input type="text" name="item_name" id="item_name" class="form-control" value="<?php echo ($item["item_name"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="time" class="col-sm-2 control-label">时间</label>
                <div class="col-sm-8">
                    <input type="date" name="time" id="time" class="form-control" value="<?php echo ($item["time"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="place" class="col-sm-2  control-label"><text class="center">地点</text></label>
                <div class="col-sm-8">
                    <input type="text" name="place" id="place" class="form-control" value="<?php echo ($item["place"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="detail" class="col-sm-2  control-label">描述</label>
                <div class="col-sm-8">
                    <textarea class="form-control" rows="3" id="detail" name="detail" ><?php echo ($item["detail"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <img src="<?php echo ($item["item_img"]); ?>" id="item_img" width="150" height="150">
                </div>
            </div>
            <div class="form-group">
                <label for="type0" class="col-sm-2 control-label">类型</label>
                 <?php if($item["type"] == 0): ?><label class="radio-inline">
                     ...
                     <label class="radio-inline">
                         <input type="radio" name="type" value="1" checked>捡到的物品
                     </label><?php endif; ?>
                <input type="text" id="target" hidden value="<?php echo ($item["item_id"]); ?>">
            </div>
        </form>
...
<script>
    var postItem = {
        check: function() {
            ...
            var url = '/TPs/infoBoard/index.php?m=home&c=item&a=do_editItem';
            var data = {'item_id':item_id,'item_name':item_name,'time':time,'place':place,'detail':detail,'type':type,'item_img':item_img};
