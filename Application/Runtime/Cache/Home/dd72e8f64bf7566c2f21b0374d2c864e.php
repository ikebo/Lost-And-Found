    ...
    <div class="col-md-2">
        <nav>
            <ul class="nav nav-pills nav-stacked myinfo-ul">
                ...
                <li role="presentation" class="active"><a href="<?php echo U('Info/itemInfo');?>">基本信息</a></li>
    ...
    <div class="col-md-8">
        <table class="table table-striped ">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a style="text-decoration: none;" href="/TPs/infoBoard/index.php?m=home&c=item&a=xdetail&item_id=<?php echo ($item["item_id"]); ?>">查看</a></td>
                    <td>
                        <button type="button" style="border: 0px; background-color: #ffffff;" class="edit" aria-label="edit">
                            ...
                            <input type="text"  hidden  value="<?php echo ($item["item_id"]); ?>">
                        </button>
