...
<div class="container container-info">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            <li style="margin-bottom: 10px;"><a href="<?php echo U('Index/index');?>" >查看全部</a></li>
            <li style="margin-bottom: 10px;"><a href="<?php echo U('Index/foundIndex');?>" style="color: grey; background-color: #eeeeee;">招领物品</a></li>
